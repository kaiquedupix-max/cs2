...
O executável se chama `legitbaratinho.xyz.exe`.
...
Autores originais: [xfi0](https://github.com/xfi0) / domok. Personalização da interface: legitbaratinho.xyz. O projeto é gratuito e mantém a licença GPL-3.0 disponível em [LICENSE](LICENSE).
